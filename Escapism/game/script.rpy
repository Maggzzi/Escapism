    ...
    # seesaw.stage = 3
        ...
        menu:
            ...
            "Ask if she'd like to play with Inaya on the seesaw":
                n "Wow.. i knew you were gonna say something like that..."
...
label picnic_scene:
    ...
    n "Something more than meets the eye..."
    z "How so?"
    ...
    z "Lets just... take a closer look before we decide on that."
...
label cake_interaction:
    ...
    n "..."
    z "..Uh - do you have any idea whose name it could be?"
    ...
    z "Wha? no, i couldn't! it's clearly made for someone else and i.. shouldn't... "
    ...
    menu:
        "Eat the cake":
            if cutlery in inventory:
                ...
                n "I bet you'd actually do that, given how your eating {i}someone else's{/i} birthday cake like it's your own."
                ...
                "It's delicious! You finish it in one sitting, however, you sneak a glance on Noors face..."
                "She doesn't really seem to enjoy it that much."

                n "Of all things, there HAD to be jam inside..."
                z "Uh, but don't cakes normally get filled with jam? That's pretty common."
                ...
                z "Hold up, just let me finish this side and..."
                z "?"
                z "Whats that... weird thing inside? in the middle?"
                "You see something crumpled up like a ball - and around it there are..."
                z "Glass shards?"
                z "Wha-- why are there pieces of glass placed inside the cake??"
                z "I-i didn't feel anything sharp in my throat... even while chewing."
                n "I guess we were lucky we didnt begin eating it from the middle."
                ...
                n "{i}Sigh{/i}. This photo.. why is this here?"
                z "Well, most importantly, why is that girl with kid me in this photo in the first place?"
                ...
                "You notice the same shortcake in the photo, with the names now being visible:"
...
label fortune_teller:
    ...
    f "As mentioned before, you, Zuha Hassan can only solve my challenge if she's succesfully solved every mystery in this space."
